...
export class Initial1643030553672 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" bigint NOT NULL, "name" character varying NOT NULL, "username" character varying, "rating" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "player" ("won" boolean NOT NULL, "userId" bigint NOT NULL, "gameId" bigint NOT NULL, "initialRoleId" integer, "finalRoleId" integer, "loverUserId" bigint, CONSTRAINT "PK_1226352721f49996c9bf0bbe9d2" PRIMARY KEY ("userId", "gameId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_chat" ("chatId" bigint NOT NULL, "userId" bigint NOT NULL, CONSTRAINT "PK_50760d81e93441fd7358d3ccdde" PRIMARY KEY ("chatId", "userId"))`);
